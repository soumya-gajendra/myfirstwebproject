...
(async() => {
  ...
  await page.goto('https://www.imdb.com/title/tt7865090/episodes/?ref_=tt_eps_sm',{ waitUntil: 'networkidle2', timeout: 60000 });
...
//  const data = Array.from(document.querySelectorAll('.ipc-title-link-wrapper'))
 ...
 // const m = e.querySelector('.ipc-slate.ipc-slate--base.ipc-slate--dynamic-width.sc-ccd6e31b-2.hRnXqd.ipc-sub-grid-item.ipc-sub-grid-item--span-4    .ipc-media ipc-media--slate-16x9 ipc-image-media-ratio--slate-16x9.ipc-media--base ipc-media--slate-m ipc-slate__slate-image.ipc-media__img   .ipc-image').getAttribute('src')
    array.push({Episode:man.textContent,date:ma.textContent,summery:a.textContent})
 });
 return array ;
  });
